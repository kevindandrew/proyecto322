...
function layout({ children }) {
  return (
    <div className="grid grid-cols-[20rem_1fr] h-screen bg-slate-100">
      <div className="p-4">
        <div className="bg-slate-700 h-full  ">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit sed
          doloremque minima. Libero adipisci aperiam assumenda perspiciatis
          reiciendis eius consequatur facere! Enim sit asperiores magni
          quibusdam adipisci omnis labore magnam. Lorem ipsum dolor sit amet
          consectetur adipisicing elit. Sit sed doloremque minima. Libero
          adipisci aperiam assumenda perspiciatis reiciendis eius consequatur
          facere! .
        </div>
      </div>
      <section className="py-4">
        ...
        <div className="p-4">
          <section className="bg-white rounded-3xl p-8">{children}</section>
        </div>
      </section>
    </div>
  );
